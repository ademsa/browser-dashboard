    ...
    return (
        <React.Fragment>
            ...
            {navigator.userAgent.indexOf("Chrome") > -1 &&
                <div className="columns is-vcentered is-mobile is-multiline">
                    <div className="column is-6-mobile is-5-tablet has-text-centered">
                        <FeatureSupportPerBrowser browser="Chrome" browserStats={props.stats.chrome} />
                    </div>
                    <div className="column is-6-mobile is-5-tablet has-text-centered">
                        <FeatureSupportPerBrowser browser="Chrome for Android" browserStats={props.stats.and_chr} />
                    </div>
            ...
            {navigator.userAgent.indexOf("Edge") > -1 &&
                <div className="columns is-vcentered is-mobile is-multiline">
                    <div className="column is-12-mobile is-10-tablet has-text-centered">
                        <FeatureSupportPerBrowser browser="Edge" browserStats={props.stats.edge} />
                    </div>
                    <div className="column is-12-mobile is-narrow-tablet has-text-centered">
                        <a href={"https://caniuse.com/#feat=" + props.name}>Other browsers</a>
                    </div>
            ...
            {navigator.userAgent.indexOf("Safari") > -1 &&
                <div className="columns is-vcentered is-mobile is-multiline">
                    <div className="column is-6-mobile is-5-tablet has-text-centered">
                        <FeatureSupportPerBrowser browser="Safari" browserStats={props.stats.safari} />
                    </div>
                    <div className="column is-6-mobile is-5-tablet has-text-centered">
                        <FeatureSupportPerBrowser browser="Safari for iOS" browserStats={props.stats.ios_saf} />
                    </div>
                    <div className="column is-12-mobile is-narrow-tablet has-text-centered">
                        <a href={"https://caniuse.com/#feat=" + props.name}>Other browsers</a>
                    </div>
