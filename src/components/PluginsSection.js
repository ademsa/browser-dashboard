    ...
    <React.Fragment>
      <section className="section" id="plugins">
        <div className="container">
          <p className="title is-3 has-text-weight-light has-text-centered">
            Plugins
          </p>
          {props.plugins.length > 0 ? (
            <React.Fragment>
              <p className="subtitle is-5 has-text-centered">
                {props.plugins.length} plugin(s) detected{" "}
                <a href="#plugins-notes" onClick={scrollToNotes}>
                  *
                </a>
              </p>
              <div className="columns is-vcentered is-centered is-mobile is-multiline">
                ...
                <div className="column is-6-mobile is-4-tablet has-text-left-mobile">
